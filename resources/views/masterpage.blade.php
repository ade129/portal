      ...
      {{-- sidebar menu --}}
        <div class="user-panel">
          ...
          <ul class="sidebar-menu" data-widget="tree">
              ...
              {{-- untuk master --}}
              @if (Auth::user()->role_type == "MAN")
                  <li class="treeview" id="menu_master">
                    <a href="#">
                      <i class="fa fa-copyright"></i> <span>Portal</span>
                    ...
                    <ul class="treeview-menu">
                      ...
                      <li id="submenu_tags"><a href="{{url('tags')}}"><i class="fa fa-tags"></i> Tags</a></li>
                      <li id="submenu_tags"><a href="{{url('tags')}}"><i class="fa fa-pencil"></i>Quotes Tags</a></li>
                    </ul>
                 </li>
